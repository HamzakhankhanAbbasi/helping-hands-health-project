...
<section class="index-banner family-support-banner inner-banner">
	<div class="container">
		<div class="text-box" data-aos="zoom-in" data-aos-duration="1300">
			<h1 class="heading">Family Support</h1>
		</div>
	</div>
		...
		<div class="covid-gen-row row align-items-center">
			<div class="col-lg-6 col-md-12 col-12 ">
				<div class="img-box gen-radius" data-aos="fade-right" data-aos-duration="1000">
					<img src="assets/images/family-sup-sec-img-1.png" alt="img" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-6 col-md-12 col-12 ">
