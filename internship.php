...
<section class="index-banner intership-banner inner-banner">
	<div class="container">
		<div class="text-box" data-aos="zoom-in" data-aos-duration="1300">
			<h1 class="heading">Internship</h1>
		</div>
	</div>
...
<section class="covid-sec-1 internship-sec-1">
	<div class="container">
		<div class="top-text-box">
			<div class="img-box">
				<img src="assets/images/page-logo-img.png" alt="img" class="img-fluid">
			</div>
			<h1 class="heading">Providing Valuable Experience</h1>
		</div>
		<div class="covid-gen-row row align-items-center">
			<div class="col-lg-6 col-md-12 col-12 order-lg-1 order-md-2 order-2">
				<div class="img-box gen-radius" data-aos="fade-right" data-aos-duration="1000">
					<img src="assets/images/internship-img-1.png" alt="img" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-6 col-md-12 col-12 order-lg-2 order-md-1 order-1">
				<div class="gen-text-box ps-3" data-aos="fade-left" data-aos-duration="1000">
					...
					<p class="tagline mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum sus pendisse ultrices gravida. Risus commodo vive rra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sit.</p>
					<a href="#!" class="purple-btn apply-btn">Apply Now</a>
				</div>
			</div>
		</div>
	</div>
...
<section class="internship-sec-2">
	<div class="container">
		<div class="top-text-box text-center">
			<p class="heading">INTERSHIP PROGRAM</p>
			<h1 class="sub-heading">Available Internship</h1>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-12">
					<div class="intern-card">
						<div class="img-box">
							<img src="assets/images/intern-card-img-1.png" alt="img" class="img-fluid">
						</div>
						<p class="heading">Lorem Lipsum</p>
						<p class="tagline">Lorem ipsum dolor sit amet, consect etur adipiscing elit, sed do eiusmod tempor incididunt ut labo Lorem ipsum dolor sit amet, consect etur ad.</p> 
						<a href="#!" class="purple-btn apply-btn">Apply Now</a>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="intern-card">
						<div class="img-box">
							<img src="assets/images/intern-card-img-2.png" alt="img" class="img-fluid">
						</div>
						<p class="heading">Lorem Lipsum</p>
						<p class="tagline">Lorem ipsum dolor sit amet, consect etur adipiscing elit, sed do eiusmod tempor incididunt ut labo Lorem ipsum dolor sit amet, consect etur ad.</p> 
						<a href="#!" class="purple-btn apply-btn">Apply Now</a>
				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="intern-card">
						<div class="img-box">
							<img src="assets/images/intern-card-img-3.png" alt="img" class="img-fluid">
						</div>
						<p class="heading">Lorem Lipsum</p>
						<p class="tagline">Lorem ipsum dolor sit amet, consect etur adipiscing elit, sed do eiusmod tempor incididunt ut labo Lorem ipsum dolor sit amet, consect etur ad.</p> 
						<a href="#!" class="purple-btn apply-btn">Apply Now</a>
				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="intern-card">
						<div class="img-box">
							<img src="assets/images/intern-card-img-4.png" alt="img" class="img-fluid">
						</div>
						<p class="heading">Lorem Lipsum</p>
						<p class="tagline">Lorem ipsum dolor sit amet, consect etur adipiscing elit, sed do eiusmod tempor incididunt ut labo Lorem ipsum dolor sit amet, consect etur ad.</p> 
						<a href="#!" class="purple-btn apply-btn">Apply Now</a>
				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="intern-card">
						<div class="img-box">
							<img src="assets/images/intern-card-img-5.png" alt="img" class="img-fluid">
						</div>
						<p class="heading">Lorem Lipsum</p>
						<p class="tagline">Lorem ipsum dolor sit amet, consect etur adipiscing elit, sed do eiusmod tempor incididunt ut labo Lorem ipsum dolor sit amet, consect etur ad.</p> 
						<a href="#!" class="purple-btn apply-btn">Apply Now</a>
				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="intern-card">
						<div class="img-box">
							<img src="assets/images/intern-card-img-6.png" alt="img" class="img-fluid">
						</div>
						<p class="heading">Lorem Lipsum</p>
						<p class="tagline">Lorem ipsum dolor sit amet, consect etur adipiscing elit, sed do eiusmod tempor incididunt ut labo Lorem ipsum dolor sit amet, consect etur ad.</p> 
						<a href="#!" class="purple-btn apply-btn">Apply Now</a>
