...
<section class="index-banner our-finance-banner inner-banner">
	<div class="container">
		<div class="text-box" data-aos="zoom-in" data-aos-duration="1300">
			<h1 class="heading">Our Finance</h1>
		</div>
	</div>
...
<section class="covid-sec-1 our-finance-sec-1">
	<div class="container">
		<div class="top-text-box">
			<h1 class="heading pt-0">Helping Hand Adapt</h1>
		</div>
		<div class="covid-gen-row row align-items-center">
			<div class="col-lg-6 col-md-12 col-12">
				<div class="img-box gen-radius" data-aos="fade-right" data-aos-duration="1000">
					<img src="assets/images/our-finance-sec1-img.png" alt="img" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-6 col-md-12 col-12">
				<div class="gen-text-box ps-3" data-aos="fade-left" data-aos-duration="1000">
					...
					<p class="tagline mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum sus pendisse ultrices gravida. Risus commodo vive rra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum su spendisse ultrices gravida. Risus commodo vive rra maecenas accumsan lacus vel facilisis. </p>
				</div>
			</div>
		</div>
	</div>
...
<section class="index-sec-2 our-finance-sec-2">
	<div class="container">
		<div class="text-box">
			<h1 class="heading">OUR VALUES</h1>
			<p class="tagline">Fostering Safe Spaces for Everyones</p>
		</div>
		<div class="row index-2-cards">
			<div class="col-lg-4 col-md-4 col-sm-6 col-12">
				<div class="index-card text-center" data-aos="fade-up" data-aos-duration="1000">
					...
					<h1 class="title">Diversity & Inclusion</h1>
					<p class="tagline">Lorem ipsum dolor sit amet, co nsectetur adipis cing elit, sed  do eiusmod tempor inci.Lorem ipsum dolor sit amet, co nsectetur adip iscing elit, sed do eiusmod tempor inci.Lorem ipsum dolor sit amet, co nsectetur adipiscing elit, sed  do eiusmod tempor inci.</p>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-12">
				<div class="index-card text-center" data-aos="fade-up" data-aos-duration="1000">
					<div class="img-box">
						<img src="assets/images/finance-card-1-img.png">
					</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-12">
				<div class="index-card text-center" data-aos="fade-up" data-aos-duration="1000">
					<div class="img-box">
						<img src="assets/images/finance-card-2-img.png">
					</div>
