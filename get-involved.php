...
<section class="index-banner get-involved-banner inner-banner">
	<div class="container">
		<div class="text-box" data-aos="zoom-in" data-aos-duration="1300">
		<h1 class="donate-head">GET INVOLVED</h1>
		<p class="tagline-2">how to make a difference</p>
		</div>
	</div>
...
<section class="index-sec-2 culture-sec-1">
	<div class="container">
		<div class="text-box">
			<h1 class="heading">LOREM ISPUM</h1>
			<p class="tagline">Lorem Ispum Dummy</p>
		</div>
		<div class="row index-2-cards">
			<div class="col-lg-3 col-md-4 col-sm-6 col-12">
				<div class="index-card text-center" data-aos="fade-up" data-aos-duration="1000">
					<div class="img-box">
						<img src="assets/images/sexual-icon-1.png">
					</div>
					<h1 class="title">Lorem Lipsum</h1>
					<p class="tagline">Lorem ipsum dolor sit amet, co nsectetur adipiscing elit, sed do eiusomd tempor inci.</p>
				</div>
			</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-12">
				<div class="index-card text-center" data-aos="fade-up" data-aos-duration="1000">
					<div class="img-box">
						<img src="assets/images/get-involve-sec-icon-1.png">
					</div>
					<h1 class="title">Lorem Lipsum</h1>
					<p class="tagline">Lorem ipsum dolor sit amet, co nsectetur adipiscing elit, sed do eiusomd tempor inci.</p>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-12">
				<div class="index-card text-center" data-aos="fade-up" data-aos-duration="1000">
					<div class="img-box">
						<img src="assets/images/sexual-icon-3.png">
					</div>
					<h1 class="title">Lorem Lipsum</h1>
					<p class="tagline">Lorem ipsum dolor sit amet, co nsectetur adipiscing elit, sed do eiusomd tempor inci.</p>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-12">
				<div class="index-card text-center" data-aos="fade-up" data-aos-duration="1000">
					<div class="img-box">
						<img src="assets/images/com-sec-icon-2.png">
					</div>
					<h1 class="title">Lorem Lipsum</h1>
					<p class="tagline">Lorem ipsum dolor sit amet, co nsectetur adipiscing elit, sed do eiusomd tempor inci.</p>
				</div>
...
<section class="sexual-sec-1 get-involved-sec-1">
	<div class="container">
		<div class="text-box">
			<div class="img-box">
				<img src="assets/images/page-logo-img.png" alt="img" class="img-fluid">
			</div>
			<h1 class="heading">Make a Donation</h1>
			<p class="tagline">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.  </p>
			<p class="tagline pt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </p>
		</div>
	</div>
</section>

<section class="covid-sec-1 sexual-sec-2  get-involved-sec-2">
	<div class="container">	
		<div class="covid-gen-row row align-items-center">
			<div class="col-lg-6 col-md-12 col-12">
				<div class="img-box gen-radius" data-aos="fade-right" data-aos-duration="1000">
					<img src="assets/images/get-involve-sec-img-1.png" alt="img" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-6 col-md-12 col-12">
				<div class="gen-text-box ps-3" data-aos="fade-left" data-aos-duration="1000">
					<h1 class="heading">Lorem Ispum Dummy</h1>
					<p class="tagline">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum sus pendisse ultrices gravida. Risus commodo vive rra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sit.tempor incididunt ut labore et dolore magna aliqua. Quis ipsum sus pendisse ultrices gravida. Risus commodo vive rra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sitdolore magna aliqua. Quis ipsum sus pendisse ultrices gravida. Risus commodo vive rra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sit.</p> 
				</div>
			</div>
		</div>
	</div>
...
<section class="covid-sec-2 sexual-sec-3 get-involved-sec-3">
	<div class="container">
		<div class="covid-gen-row row align-items-center">
			<div class="col-lg-6 col-md-12 col-12 order-lg-1 order-md-2 order-2">
				<div class="gen-text-box" data-aos="fade-right" data-aos-duration="1000">
					<h1 class="heading">Lorem Ispum Dummy</h1>
					<p class="tagline">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum sus pendisse ultrices gravida. Risus commodo vive rra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sit.tempor incididunt ut labore et dolore magna aliqua. Quis ipsum sus pendisse ultrices gravida. Risus commodo vive rra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sitdolore magna aliqua. Quis ipsum sus pendisse ultrices gravida. Risus commodo vive rra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sit. </p>
			...
			<div class="col-lg-6 col-md-12 col-12 order-lg-2 order-md-1 order-1">
				<div class="img-box gen-radius pt-3" data-aos="fade-left" data-aos-duration="1000">
					<img src="assets/images/get-involve-sec-img-2.png" alt="img" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
