...
<section class="index-banner career-banner inner-banner">
	<div class="container">
		...
		<div class="covid-gen-row row align-items-center">
			<div class="col-lg-6 col-md-12 col-12 order-lg-1 order-md-2 order-2">
				<div class="img-box gen-radius" data-aos="fade-right" data-aos-duration="1000">
					<img src="assets/images/career-sec-1-img.png" alt="img" class="img-fluid">
				</div>
			</div>
...
<section class="index-sec-2 career-sec-1">
	<div class="container">
		<div class="text-box">
