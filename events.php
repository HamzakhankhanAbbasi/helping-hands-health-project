...
<section class="index-banner event-banner inner-banner">
	<div class="container">
		...
		<div class="covid-gen-row row align-items-center">
			<div class="col-lg-6 col-md-12 col-12">
				<div class="img-box gen-radius" data-aos="fade-right" data-aos-duration="1000">
					<img src="assets/images/event-sec-img-1.png" alt="img" class="img-fluid gen-radius w-100">
				</div>
			</div>
			<div class="col-lg-6 col-md-12 col-12">
				<div class="gen-text-box ps-3" data-aos="fade-left" data-aos-duration="1000">
					...
					<a href="#!" class="purple-btn apply-btn">See Calender</a>
				</div>
			</div>
		</div>
	</div>
...
<section class="covid-sec-1 internship-sec-1 event-sec-2">
	<div class="container">
		<div class="covid-gen-row row align-items-center">
			...
			<div class="col-lg-6 col-md-12 col-12 order-lg-2 order-md-1 order-1">
				<div class="img-box" data-aos="fade-left" data-aos-duration="1000">
					<img src="assets/images/event-sec-img-2.png" alt="img" class="img-fluid gen-radius w-100">
				</div>
			</div>
		</div>
	</div>
...
<section class="community-sec-2 event-sec-3">
	<div class="container">
		<div class="text-box">
			<h1 class="heading">Camaraderie Gala</h1>
			<p class="tagline">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.  </p>
