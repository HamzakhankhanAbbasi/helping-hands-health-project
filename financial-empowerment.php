...
<section class="index-banner financial-empower-banner inner-banner">
	<div class="container">
		<div class="text-box" data-aos="zoom-in" data-aos-duration="1300">
			<h1 class="heading">Financial Empowerment</h1>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="row index-2-cards">
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-12">
				<div class="index-card text-center" data-aos="fade-up" data-aos-duration="1000">
					<div class="img-box">
						<img src="assets/images/sexual-icon-2.png">
					</div>
					<h1 class="title">Lorem Lipsum</h1>
					<p class="tagline">Lorem ipsum dolor sit amet, co nsectetur adipiscing elit, sed do eiusomd tempor inci.</p>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-12">
				<div class="index-card text-center" data-aos="fade-up" data-aos-duration="1000">
					<div class="img-box">
						<img src="assets/images/sexual-icon-4.png">
					</div>
					<h1 class="title">Lorem Lipsum</h1>
					<p class="tagline">Lorem ipsum dolor sit amet, co nsectetur adipiscing elit, sed do eiusomd tempor inci.</p>
				</div>
...
<section class="sexual-sec-1">
	<div class="container">
		<div class="text-box">
			<div class="img-box">
				<img src="assets/images/page-logo-img.png" alt="img" class="img-fluid">
			</div>
			<h1 class="heading">Helping Hand Adapt</h1>
...
<section class="covid-sec-1 sexual-sec-2">
	<div class="container">	
		<div class="covid-gen-row row align-items-center">
			<div class="col-lg-6 col-md-12 col-12">
				<div class="img-box gen-radius" data-aos="fade-right" data-aos-duration="1000">
					<img src="assets/images/finance-empower-sec-img-1.png" alt="img" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-6 col-md-12 col-12 ">
...
<section class="covid-sec-2 sexual-sec-3">
	<div class="container">
		<div class="covid-gen-row row align-items-center">
			...
			<div class="col-lg-6 col-md-12 col-12 order-lg-2 order-md-1 order-1">
				<div class="img-box gen-radius" data-aos="fade-left" data-aos-duration="1000">
					<img src="assets/images/finance-empower-sec-img-2.png" alt="img" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
